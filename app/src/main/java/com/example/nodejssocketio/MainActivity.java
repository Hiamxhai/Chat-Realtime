...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mapping();
        try {
            mSocket = IO.socket("http://192.168.1.249:3000/");
        ...
        mSocket.on("sever-send-chat", onListChat);
                ...
                public void run() {
                    ...
                    try {
                        ...
                        if (exits) {
                            ...
                            Toast.makeText(MainActivity.this, "Đăng kì thành công ! ", Toast.LENGTH_SHORT).show();
                        }
